...
//  "port4_id" = aws_network_interface.ni-active-port4.id
...
//  "port4_ip" = aws_network_interface.ni-active-port4.private_ip
...
//  "port4_id" = aws_network_interface.ni-passive-port4.id
...
//  "port4_ip" = aws_network_interface.ni-passive-port4.private_ip
  }
}
...
//  "mpls_net"      = aws_subnet.subnet-az1-mpls.cidr_block
...
//  "mpls_net"      = aws_subnet.subnet-az2-mpls.cidr_block
